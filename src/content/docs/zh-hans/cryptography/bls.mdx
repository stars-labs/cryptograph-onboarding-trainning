...
把 G₁ 和 G₂ 想成两个操场，P 和 Q 是操场上的两个玩具。  
**配对函数**就像一台“合成照相机”：把两个操场的玩具一起拍成一张“合成照片”。  
这张照片放在第三个地方 Gₜ 里，我们就能拿着它来“比对关系”。
...
所以你可以把配对函数理解成：**“两边的放大倍数可以挪来挪去，结果还是对的。”**
...
页面里用“乘法”来模拟配对函数，目的是让你直观看到 **双线性** 如何让等式成立。
